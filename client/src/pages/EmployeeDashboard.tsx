    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col">
      ...
      <div className="flex">
        <SidebarProvider className="h-full flex-1">
          <Sidebar className="bg-white border-r mt-[36px] w-56 min-h-full py-8 px-2">
                  ...
                  {mockJobs.map((job) => (
                    <div key={job.id} className="bg-white rounded shadow p-6">
                      ...
                      <Button
                        ...
                        disabled={applyJobId !== null && applyJobId !== job.id}
                      >
                        Apply
                      </Button>
                      {applyJobId === job.id && (
                        <div className="mt-6 border-t pt-4">
                          ...
                          <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <Input
                              name="portfolio"
                              placeholder="Portfolio Link or GitHub"
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  ...
                  {notifications.map((n) => (
                    <li
                      key={n.id}
                      className="bg-gray-100 rounded px-4 py-2 text-sm"
                    >
                      {n.message}{" "}
